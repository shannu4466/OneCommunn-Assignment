  ...
  render() {
    return (
      <div className="process-container">
        ...
        <div className="steps">
          <div className="step">
            <img src="public/assets/step1.png"/>
            <div>
          ...
          <div className="step">
          <img src="public/assets/step2.png"/>
            <div>
          ...
          <div className="step">
          <img src="public/assets/step3.png"/>
            <div>
          ...
          <div className="step">
          <img src="public/assets/step4.png"/>
            <div>
          ...
          <div className="step">
          <img src="public/assets/step5.png"/>
            <div>
          ...
          <div className="step">
          <img src="public/assets/step6.png"/>
            <div>
